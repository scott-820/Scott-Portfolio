...
This Arduino sketch implements a Microwave Receiver Signal Strength to DC Volts Output Simulator using an Arduino Nano, a SSD-1306 OLED, an Adafruit BNO055 9-axis Inertial Measurement Unit and a MCP4725 I2C 12-bit DAC.
